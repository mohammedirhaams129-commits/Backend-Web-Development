...
// with the size of the file. A stream moves the file in chunks, so it does not
// need to keep the entire file in memory and peak memory stays mostly flat even
